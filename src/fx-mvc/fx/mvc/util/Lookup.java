...
public final class Lookup {
  ...
  private final static ClassValue<MethodHandle> getId = new ClassValue<MethodHandle>() {
    @Override
  ...
  private final static ClassValue<MethodHandle> getItems = new ClassValue<MethodHandle>() {
    @Override
    protected MethodHandle computeValue(Class<?> refc) {
